...
3. **Design Model**
	...
	* Using keras generator
		...
		* onto Model: I read a couple of posts which are referenced in the reference sections about how to set up keras sequential model and how to use the API's.	

4. **Model Architecture**
	* -- update -- NVIDIA paper is the one that I first go to. I implemented the same layers as NVIDIA to try out at first and I cannot achieve the desire outcome. I might need to come back to set up again to try it out later.
